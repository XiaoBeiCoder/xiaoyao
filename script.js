...
noButton.addEventListener("click", function () {
    ...
    // 图片变化（前 5 次变化）
    // 震惊 修改为绝对路径
    if (clickCount === 1) mainImage.src = "https://vip.123pan.cn/1829447704/xiaoyaoweb/shocked.png";  
    // 思考 修改为绝对路径  
    if (clickCount === 2) mainImage.src = "https://vip.123pan.cn/1829447704/xiaoyaoweb/think.png";  
    // 生气 修改为绝对路径  
    if (clickCount === 3) mainImage.src = "https://vip.123pan.cn/1829447704/xiaoyaoweb/angry.png"; 
    // 哭 修改为绝对路径    
    if (clickCount === 4) mainImage.src = "https://vip.123pan.cn/1829447704/xiaoyaoweb/crying.png";   
    // 之后一直是哭
    if (clickCount >= 5) mainImage.src = "https://vip.123pan.cn/1829447704/xiaoyaoweb/crying.png";
...
yesButton.addEventListener("click", function () {
    document.body.innerHTML = `
        <div class="yes-screen">
            ...
            <img src="https://vip.123pan.cn/1829447704/xiaoyaoweb/hug.png" alt="拥抱" class="yes-image">   
        </div>
    `;
